...
class Fontify(nn.Module):
    ...
    def forward_loss(self, imgs, pred, tgts, mask, valid):
        """
        tgts: [N, 3, H, W]
        pred: [N, 3, H, W]
        ...
        loss = loss_l1l2 + loss_vgg  + 0.1 * adv_loss +0.8*loss_edge
    ...
    def forward(self, imgs, tgts, bool_masked_pos=None, valid=None):
        ...
        #loss, loss_l1l2, loss_vgg = self.forward_loss(imgs, pred, tgts, bool_masked_pos, valid)
        return self.patchify(pred), bool_masked_pos, pred
